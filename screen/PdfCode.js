...
<html>
  ...
  <body >
    ...
    <div class="data-title">
        ...
        font-size: 2rem;  
        padding-left: 20px;">Shivam Shop<br></div>
    <div style="
    display: flex;
    flex-direction: column;
    align-items: flex-start; 
    ...
    width: 90px;
    margin-right:15px;
        " src="https://cdn.pixabay.com/photo/2016/07/30/08/18/moscow-1556564_960_720.jpg" />
    </div>
    <hr />
        <hr/>
        ...
        <div style="height:auto; padding: 20px;">
            ...
            Bank Name: HDFC BANK,LUCKNOW<br/>
            Bank Account no : 66778877967118<br/>
            Bank IFSC code : HDFC67890<br/>
            </p>
